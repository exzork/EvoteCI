            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mt-3">
                        <?php foreach ($data_calon as $key => $calon) : ?>
                            <div class="col-md-3 col-12 col-sm-4 mt-2">
                                <div class="card h-100">
                                    <img class="card-img-top img-fluid" id="img_<?php echo $calon['kode_calon']; ?>"
                                         src="https://lh3.googleusercontent.com/d/<?php echo $calon['foto_calon']; ?>"
                                         alt="Card image" style="width:100%">
                                    <div class="card-body d-flex flex-column">
                                        <div class="mt-auto">
                                            <h5 class="card-title"
                                                id="nama_<?php echo $calon['kode_calon']; ?>"><?php echo $calon['nama_ketua'] . "<br>" . $calon['nama_wakil']; if($calon['nama_wakil'])echo "<br>"; ?></h5>
                                            <br><br>
                                            <button href="#" class="btn mb-2 btn-success mt-auto btn-block"
                                                    onclick="pesan('<?php echo $calon['kode_calon']; ?>')">Visi Misi
                                            </button>
                                            <button href="#" class="btn mt-2 btn-primary mt-auto btn-block"
                                                    onclick="pilih('<?php echo $calon['kode_calon']; ?>')">Pilih Calon
                                                Ini
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <?php endforeach; ?>
                        <button class="btn btn-secondary w-100 mt-2" onclick="next('<?php echo $judul_pem; ?>')">Next
                        </button>
                    </div>
                </div>
            </div>
...
<?php if ($rekap == 0) : ?>
<div class="card col-md-4 col-sm-12 mx-auto hidden" id="card_bukti">
    <?php endif ?>
    <?php if ($rekap == 1) : ?>
    <div class="card col-md-4  col-sm-12 mx-auto" id="card_bukti">
        <?php endif ?>
        <div class="card-header">
            <div class="card-title w-100">
                <h3 style="text-align: center;">Bukti Penggunaan Suara</h3>
            </div>
        </div>
        <div class="card-body">
            <form action="#" id="form_pilih">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title w-100"><h3><b>Foto Diri</b></h3></div>
                    ...
                    <div class="card-footer">
                        <button id="startbutton" class="btn btn-primary form-control"
                                onclick="$('#submit_btn').removeAttr('disabled')">Take photo
                        </button>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <div class="card-title w-100"><h3><b>File Foto KTM</b></h3></div>
                        <div class="card-text"><b>
