				...
				<div class="nk-content ">
					<div class="nk-block nk-block-middle wide-md mx-auto">
						<div class="nk-block-content nk-error-ld text-center">
							<img class="nk-error-gfx" src="<?= base_url('img/error-504.svg') ?>" alt="">
							<div class="wide-xs mx-auto">
								<h3 class="nk-error-title">Terjadi kesalahan</h3>
								<p class="nk-error-text">Silahkan hubungi admin</p>
